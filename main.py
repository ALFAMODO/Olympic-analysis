...
st.sidebar.title('Olympic Filters')
...
if user_menu == 'Overall Analysis':
    ...
    st.title("No of events over time (Sports)")
...
if user_menu == 'Country wise analysis':
    ...
    st.title('Medal over the years by ' + selected_country)
    st.plotly_chart(fig)

    st.title(selected_country + ' Excels in sports')
...
if user_menu == 'Athlete wise analysis':
    ...
    famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics', 'Swimming',
                     ...
                     'Baseball',
                     'Rugby Sevens', 'Triathlon', 'Curling', 'Snowboarding', 'Rugby', 'Polo',
                     ]
    x = []
    name = []
